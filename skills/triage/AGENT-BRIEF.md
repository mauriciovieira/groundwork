...
### Good agent brief (enhancement, HITL)
...
Marked `HITL` here because the file format and matching heuristic are design decisions worth a human sanity check before an agent runs with them, not because the implementation itself is risky.
